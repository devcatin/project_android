...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.erik.android.androidlean.ohter.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.erik.android.androidlean.ohter.GlideOptions().apply(toSet));
    }
  }
}
